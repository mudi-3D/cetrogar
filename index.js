...
async function verifyDomElement() {
    let fatherContainer = document.querySelector('.fotorama-item.fotorama[data-gallery-role="gallery"]');
    let skuNumber = document.querySelector('.product-info-stock-sku .product.attribute.sku .value')?.textContent.trim();
